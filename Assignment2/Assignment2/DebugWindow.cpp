...
bool DebugWindow::Initialize(ID3D10Device* device, int screenWidth, int screenHeight, int bitmapWidth, int bitmapHeight)
{
	bool result;
...
bool DebugWindow::InitializeBuffers(ID3D10Device* device)
{
	VertexType* vertices;
